      ...
      <div class="panel panel-default">
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <div class="form-group">
              <label class="content-light">Admin ID</label>
              <input type="text" class="form-control" name="adminID" value="<?php echo (isset($_POST['adminID']) ? $_POST['adminID'] : ''); ?>" required>
            </div>
            <div class="form-group">
