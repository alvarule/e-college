...
<body class="body-own">
    ...
    ?>
            ...
            <strong>Success! </strong>Student details has been updated successfully..
    ...
    <h1 class="page-heading">Manage Students</h1>
    ...
    <div class="panel-transparent">
        ...
        <table class="table table-responsive table-hover content-bold" id="myTable">
            <thead>
                <tr>
                    <th class="content-bold">Student ID</th>
            ...
            ?>
                <tr>
                    <td class='content-light' scope='row'><?php echo $row['stud_id'];?></td>
                    ...
                    <td class='content-light'><i class='fa fa-eye' onclick="window.location.href='/e-college/admin/editStudent?s_id=<?php echo $row['stud_id'];?>';"></i></td>
                </tr>
            <?php
                }
