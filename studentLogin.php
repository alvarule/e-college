...
if(isset($_SESSION['end_user'])){
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $query = "SELECT * from `stud_login` where `stud_id`='$studentID'";
    ...
    if($num==1){
        ...
        if(password_verify($password, $row['password'])){
          ...
          elseif($row['activation']!=1){
            ...
            $_SESSION['stud_id'] = $studentID;
            $_SESSION['end_user'] = "student";
            header("Location: student/index");
          }
        }
        else{
    ...
    ?>
      ...
      <div class="panel panel-default">
          <div class="panel-body">
            ...
            <center><div class="panel-heading">Student Login</div></center>
            
          <!-- form  -->
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <div class="form-group">
              <label class="content-light">Student ID</label>
              <input type="text" class="form-control" name="studentID" id="StudentID" value="<?php echo (isset($_POST['studentID']) ? $_POST['studentID'] : ''); ?>" required>
            </div>
            <div class="form-group">
